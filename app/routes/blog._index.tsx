		...
		<main>
			<article>
				...
				<div className="post-content">
					<p>
						Here, I&apos;ll be sharing short entries about my artistic journey—my experiences, challenges, and little victories as I explore the world of watercolor and beyond. Stay tuned for more updates!
					</p>
